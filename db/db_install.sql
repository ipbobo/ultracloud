...
CREATE TABLE `t_virtualmachine` (
  ...
  `mount_disk_size` varchar(50) DEFAULT NULL  COMMENT '挂载磁盘大小',
  `mount_disk_type` varchar(50) DEFAULT NULL  COMMENT '挂载磁盘类型',
  `status` tinyint unsigned NOT NULL COMMENT '状态',
...
CREATE TABLE `t_mirrortemplate` (
  ...
  `USERNAME` varchar(20) DEFAULT NULL COMMENT '创建者',
