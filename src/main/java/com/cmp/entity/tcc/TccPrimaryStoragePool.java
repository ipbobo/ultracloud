...
/**
 * TCcPrimaryStoragePool 主存储数据库持久类
 */
public class TccPrimaryStoragePool implements java.io.Serializable {

	// Fields
	private static final long serialVersionUID = 973374252764056665L;
	...
	public Long getPstorageId() {
		return this.pstorageId;
	}

	public void setPstorageId(Long pstorageId) {
