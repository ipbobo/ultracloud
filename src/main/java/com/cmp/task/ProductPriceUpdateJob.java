 ...
 * @date 
 */
public class ProductPriceUpdateJob extends BaseController implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		logger.info("ProductPriceUpdateJob start...");
		...
		logger.info("ProductPriceUpdateJob end.");
	}
	...
	public void shutdownJob(JobExecutionContext context, PageData pd, Map<String,Object> parameter, WebApplicationContext webctx){
		try {
			...
			TimeTaskServiceImpl timingbackupService = (TimeTaskServiceImpl)webctx.getBean("timingbackupService");
