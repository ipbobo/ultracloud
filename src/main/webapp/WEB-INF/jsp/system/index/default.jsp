...
getAnnularChart('virLoadChart', ['${virLoad.loadTotalNum}台','虚拟机'], ['vertical', 'left', 'top'], ['30%', '50%'], ['50%', '75%'], ['轻${virLoad.loadLittleNum}台','中${virLoad.loadMiddleNum}台','高${virLoad.loadHeightNum}台','停${virLoad.loadStopNum}台'], ['${virLoad.loadLittleNum}', '${virLoad.loadMiddleNum}', '${virLoad.loadHeightNum}', '${virLoad.loadStopNum}'], ['#00ff00', '#ffff00', '#ff0000','#A9A9A9'], "%");//获取图表
getAnnularChart('hostLoadChart', ['${hostLoad.loadTotalNum}台','宿主机'], ['vertical', 'left', 'top'], ['30%', '50%'], ['50%', '75%'], ['轻${hostLoad.loadLittleNum}台','中${hostLoad.loadMiddleNum}台','高${hostLoad.loadHeightNum}台','停${hostLoad.loadStopNum}台'], ['${hostLoad.loadLittleNum}', '${hostLoad.loadMiddleNum}', '${hostLoad.loadHeightNum}', '${hostLoad.loadStopNum}'], ['#00ff00', '#ffff00', '#ff0000','#A9A9A9'], "%");//获取图表
getAnnularChart('physLoadChart', ['${physLoad.loadTotalNum}台','物理机'], ['vertical', 'left', 'top'], ['30%', '50%'], ['50%', '75%'], ['轻${physLoad.loadLittleNum}台','中${physLoad.loadMiddleNum}台','高${physLoad.loadHeightNum}台','停${physLoad.loadStopNum}台'], ['${physLoad.loadLittleNum}', '${physLoad.loadMiddleNum}', '${physLoad.loadHeightNum}', '${physLoad.loadStopNum}'], ['#00ff00', '#ffff00', '#ff0000','#A9A9A9'], "%");//获取图表
getAnnularChart('virRunChart', ['${virRun.runTotalNum}台','虚拟机'], ['vertical', 'left', 'top'], ['30%', '50%'], ['50%', '75%'], ['运${virRun.runRunnigNum}台','挂${virRun.runHangupNum}台','停${virRun.runCloseNum}台'], ['${virRun.runRunnigNum}','${virRun.runHangupNum}','${virRun.runCloseNum}'], ['#00ff00', '#ffff00', '#ff0000'], "%");//获取图表
getAnnularChart('hostRunChart', ['${hostRun.runTotalNum}台','宿主机'], ['vertical', 'left', 'top'], ['30%', '50%'], ['50%', '75%'], ['运${hostRun.runRunnigNum}台','挂${hostRun.runHangupNum}台','停${hostRun.runCloseNum}台'], ['${hostRun.runRunnigNum}','${hostRun.runHangupNum}','${hostRun.runCloseNum}'], ['#00ff00', '#ffff00', '#ff0000'], "%");//获取图表
getAnnularChart('physRunChart', ['${physRun.runTotalNum}台','物理机'], ['vertical', 'left', 'top'], ['30%', '50%'], ['50%', '75%'], ['运${physRun.runRunnigNum}台','挂${physRun.runHangupNum}台','停${physRun.runCloseNum}台'], ['${physRun.runRunnigNum}','${physRun.runHangupNum}','${physRun.runCloseNum}'], ['#00ff00', '#ffff00', '#ff0000'], "%");//获取图表
