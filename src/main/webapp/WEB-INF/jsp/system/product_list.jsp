						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">当前执行价格</th>
									<th class="center">修改后价格</th>
									<th class="center">修改后价格生效时间</th>
									<th class="center">最后更新时间</th>
									<th class="center">最后修改人</th>
	...
	<script type="text/javascript">
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>product/delete.do?id="+Id+"&tm="+new Date().getTime();
