				...
				<div class="row">
					<div class="col-xs-12">
						<table width="100%" style="margin-top: 8px;">
							<tr height="35">
								<td style="width: 120px;">平台类型2</td>
								<c:if test="${not empty platTypeList}">
								<c:forEach items="${platTypeList}" var="var" varStatus="st">
									<td style="width: 100px;" class="center" onMouseMove="javascript:this.bgColor='#FFC926';" <c:choose><c:when test="${var.dictDefault=='1'}">bgcolor="#FFC926" onMouseOut="javascript:this.bgColor='#FFC926';"</c:when><c:otherwise>bgcolor="#E5E5E5" onMouseOut="javascript:this.bgColor='#E5E5E5';"</c:otherwise></c:choose>>
