...
<body class="no-skin">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.openstack_rule_name}</td>
											<td class="center">
	...
	function edit(id) {
		 ...
		 diag.Drag=true;
		 diag.Title ="编辑";
		 diag.URL = '<%=basePath%>autoinstallrule/goEdit.do?id='+id+'&type=OpenStack';
		 //diag.Width = 450;
		 diag.Height = 358;
	...
	function add(){
		 ...
		 diag.Drag=true;
		 diag.Title ="新增";
		 diag.URL = '<%=basePath%>autoinstallrule/goAdd.do?type=OpenStack';
		 diag.Width = 600;
		 diag.Height = 300;
		 diag.CancelEvent = function(){ //关闭事件
			 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
