...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="quota/listProject.do" method="post" name="Form" id="Form">
						<table style="margin-top:1px;">
							<tr>
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入项目名称" class="nav-search-input" id="nav-search-input" autocomplete="off" name="name" value="${pd.name }" placeholder="这里输入用户组名称"/>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="编辑" onclick="editQuota('${var.id}');">
	...
	function editQuota(id){
		 ...
		 diag.Drag=true;
		 diag.Title ="编辑";
		 diag.URL = '<%=basePath%>quota/goEditProjectQuota.do?id='+id;
		 //diag.Width = 450;
		 diag.Height = 358;
