									...
									<div class="tab-content" style="height:100%;">
										<div id="vmware" class="tab-pane in active" style="height:500px;">
											<table id="table_vmware" class="table table-striped table-bordered table-hover">
												<iframe name="vmwareFrame" id="vmwareFrame" frameborder="0" src="<%=basePath%>/datacenternetwork/listType.do?type=vmware" style="margin:0 auto;width:100%;height:100%;"></iframe>
											</table>
										</div>
										<div id="OpenStack" class="tab-pane" style="height:500px;">
											<table id="table_OpenStack" class="table table-striped table-bordered table-hover">
												<iframe name="OpenStackFrame" id="OpenStackFrame" frameborder="0" src="<%=basePath%>/datacenternetwork/listType.do?type=OpenStack" style="margin:0 auto;width:100%;height:100%;"></iframe>
											</table>
										</div>
									</div>
								</div>
