...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="leave/signtasklist.do" method="post" name="Form" id="Form">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-success" title="签收" onclick="signtask('${var.taskId}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="签收"></i>
													</a>
												</div>
											</td>
										</tr>
	...
	function signtask(taskId) {
		bootbox.confirm("确定要签收吗?", function(result) {
			if(result) {
				top.jzts();
				var url = "<%=basePath%>leave/signtask.do?taskId="+taskId;
