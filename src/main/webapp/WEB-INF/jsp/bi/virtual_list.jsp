			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="bidatacenter/listVirtual.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;width:100%;">
							<tr>
								...
								<td style="padding-left:2px;width:60px;">状态:</td>
								<td style="padding-left:2px;width:100px;">
									<select class="chosen-select form-control" name="status" id="status" data-placeholder="请选择状态" style="vertical-align:top;"  title="状态" style="width:98%;" >
									<option value=""></option>
